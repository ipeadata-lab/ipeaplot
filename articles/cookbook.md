...
Nesta vinheta, apresentamos exemplos práticos do uso do pacote para
gerar visulizações de dados comuns em textos e relatórios do Ipea.

Em algumas figuras, os ajustes necessários para atender às diretrizes
estilísticas do Editorial do Ipea demandam a criação de códigos
específicos, extrapolando as configurações pré-estabelecidas no
**ipeaplot**.

Essa vinheta tem, por isso, um formato de *cookbook*, proporcionando
orientações práticas para a utilização de outros recursos do `ggplot2`.

Em todos os exemplos, é exibida a versão “bruta” da figura, tal como foi
submetida à Coordenação do Editorial. Em seguida, indicamos como é
possível, com o **ipeaplot** e algumas linhas de código adicionais,
...
![](prints_ipeaplot/grafico1.png)

## Gráfico 2

### Original

![](prints_original/grafico2.png)
...
![](prints_ipeaplot/grafico2.png)

## Gráfico 3

### Original

![](prints_original/grafico3.png)
...
![](prints_ipeaplot/grafico3.png)

## Gráfico 4

### Original

![](prints_original/grafico4.png)
...
![](prints_ipeaplot/grafico4.png)

## Gráfico 5

### Original

![](prints_original/grafico5.png)
...
![](prints_ipeaplot/grafico5.png)

## Gráfico 6

### Original

![](prints_original/grafico6.png)
...
![](prints_ipeaplot/grafico6.png)

## Gráfico 7

### Original

![](prints_original/grafico7.png)
...
![](prints_ipeaplot/grafico7.png)

## Gráfico 8

### Original

![](prints_original/grafico8.png)
