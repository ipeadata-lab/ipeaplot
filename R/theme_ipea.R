...
ggplot_add.scale_auto_ipea <- function(object, plot, object_name, ...) {
  ...
  if(axis_values == T){
    ...
    axis.text.x  = ggplot2::element_text(family = "Roboto-CondensedLight", angle = x_text_angle,color = 'black',
  ...
  if(include_x_text_title == T){
    axis.title.x  = ggplot2::element_text(family = "Roboto-CondensedLight",margin = margin(t = 4, r = 0, b = 0, l = 0, unit = 'mm'))
  ...
  if(include_y_text_title == T){
    axis.title.y  = ggplot2::element_text(family = "Roboto-CondensedLight",margin = margin(t = 0, r = 4, b = 0, l = 0, unit = 'mm'))
  ...
  theme <- ggplot2::theme(
    text = ggplot2::element_text(family = "Roboto-Regular"),
    #text = ggplot2::element_text(family = "Roboto-Regular",size = unit(6, unit = 'mm')),
    ...
    # axis.text = ggplot2::element_text(family = "Roboto-CondensedLight", size = unit(6, "pt")),
    ...
    plot.caption = ggplot2::element_text(family = "Roboto-CondensedLight", hjust = 0, vjust = 0,  lineheight = 1.25),
