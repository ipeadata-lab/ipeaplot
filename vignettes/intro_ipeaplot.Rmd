...
A função `theme_ipea()` aplica às figuras o padrão visual de gráficos utilizados pelo Ipea nas publicações de Texto para Discussão (TD). Ainda, a função traz uma maneira conveniente de ajustar diversas características das figuras, como por exemplo os eixos, posição da legenda, escalas dos eixos etc.
