...
There are two core functions to select color palettes: `scale_color_ipea()` and `scale_fill_ipea()`. These two function work exactly in the same way but,  the following parameters:
