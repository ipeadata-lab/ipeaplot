...
```{r eval=TRUE, message=FALSE, warning=FALSE, fig.align="center", fig.width=unit(8,"cm"), fig.height=unit(8,"cm")}
...
```{r eval=TRUE, message=FALSE, warning=FALSE,fig.align="center", fig.width=6, fig.height=7}
