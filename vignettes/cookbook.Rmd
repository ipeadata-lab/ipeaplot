...
Gráfico 1 - Original
```{r}
knitr::include_graphics("https://github.com/ipeadata-lab/ipeaplot/blob/master/vignettes/prints_original/grafico1.png?raw=true")
```
...
Gráfico 2 - Original
```{r}
knitr::include_graphics("https://github.com/ipeadata-lab/ipeaplot/blob/master/vignettes/prints_original/grafico2.png?raw=true")
```
...
Gráfico 3 - Original
```{r}
knitr::include_graphics("https://github.com/ipeadata-lab/ipeaplot/blob/master/vignettes/prints_original/grafico3.png?raw=true")
```
...
```{r}
knitr::include_graphics("https://github.com/ipeadata-lab/ipeaplot/blob/master/vignettes/prints_original/grafico4.png?raw=true")
```
...
Gráfico 5 - Original
```{r}
knitr::include_graphics("https://github.com/ipeadata-lab/ipeaplot/blob/master/vignettes/prints_original/grafico5.png?raw=true")
```
...
Gráfico 6 - Original
```{r}
knitr::include_graphics("https://github.com/ipeadata-lab/ipeaplot/blob/master/vignettes/prints_original/grafico6.png?raw=true")
```
...
Gráfico 7 - Original
```{r}
knitr::include_graphics("https://github.com/ipeadata-lab/ipeaplot/blob/master/vignettes/prints_original/grafico7.png?raw=true")
```
...
Gráfico 8 - Original
```{r}
knitr::include_graphics("https://github.com/ipeadata-lab/ipeaplot/blob/master/vignettes/prints_original/grafico8.png?raw=true")
```
...
Gráfico 9 - Original
```{r}
knitr::include_graphics("https://github.com/ipeadata-lab/ipeaplot/blob/master/vignettes/prints_original/grafico9.png?raw=true")
```
...
Gráfico 10 - Original
```{r}
knitr::include_graphics("https://github.com/ipeadata-lab/ipeaplot/blob/master/vignettes/prints_original/grafico10.png?raw=true")
```
