...
Para garantir o uso correto da fonte Roboto no pacote **ipeaplot**, siga as instruções de instalação específicas para o seu sistema operacional: [MacOS](https://support.apple.com/pt-br/guide/font-book/fntbk1000/mac), [Linux](https://askubuntu.com/questions/3697/how-do-i-install-fonts) e [Windows](https://support.microsoft.com/en-us/office/add-a-font-b7c5f17c-4426-4b53-967f-455339c564c1). Os arquivos da fonte Roboto estão disponíveis na pasta fontes do repositório [ipeaplot](https://github.com/ipeadata-lab/ipeaplot/tree/master/inst/extdata/ttf). Isso assegurará melhor suporte para fontes personalizadas nos dispositivos cairo_pdf ou cairo_ps.
